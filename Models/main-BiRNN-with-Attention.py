...
from Models.Network.BiRNN_with_Attention import BiRNN_with_Attention
from Models.Loss_Function.Loss import loss
from Models.Evaluation_Metrics.Metrics import evaluation

# Model Name
Model = 'Attention_based_Bidirectional_Recurrent_Neural_Network'
...
max_time = 64       # The unfolded time slices of the BiRNN Model
rnn_size = 256      # The number of RNNs inside the BiRNN Model
...
weights_1 = tf.Variable(tf.truncated_normal([2 * rnn_size, n_hidden], stddev=0.01))
...
# Load Model Network
prediction, features, attention_weights = BiRNN_with_Attention(Input=x,
                                                               max_time=max_time,
                                                               rnn_size=rnn_size,
                                                               n_input=n_input,
