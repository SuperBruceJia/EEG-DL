...
# Model Name
Model = 'Bidirectional_Long_Short_Term_Memory'
...
max_time  = 64   # The unfolded time slices of the BiLSTM Model
lstm_size = 256  # The number of RNNs inside the BiLSTM Model
...
# Load Model Network
prediction, features = BiLSTM(Input=x,
                             max_time=max_time,
                             n_input=n_input,
                             lstm_size=lstm_size,
                             keep_prob=keep_prob,
