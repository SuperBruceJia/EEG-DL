...
def GRU_with_Attention(Input, max_time, n_input, gru_size, attention_size, keep_prob, weights_1, biases_1, weights_2, biases_2):
    '''
    ...
    Args:
        ...
        gru_size: The number of GRU units inside the GRU Model
    ...
    # One layer Attention-based GRU Model
