...
from Models.Network.GRU_with_Attention import GRU_with_Attention
from Models.Loss_Function.Loss import loss
from Models.Evaluation_Metrics.Metrics import evaluation

# Model Name
Model = 'Attention_based_Gated_Recurrent_Unit'
...
# Load Model Network
prediction, features, attention_weights = GRU_with_Attention(Input=x,
                                                             max_time=max_time,
                                                             gru_size=gru_size,
                                                             n_input=n_input,
